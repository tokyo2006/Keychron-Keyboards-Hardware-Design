# Keychron K4 Pro — Hardware Design Files

> 96% wireless mechanical keyboard with QMK/VIA support, Bluetooth 5.1, and USB-C wired connectivity.

**Product page:** [Keychron K4 Pro](https://www.keychron.com/products/keychron-k4-pro-qmk-via-wireless-mechanical-keyboard)

![K4 Pro](https://github.com/Keychron/ProductImage/blob/main/K_Pro/k4_pro.jpg?raw=true)
...
| Layout | 96% (100-key) |
| Profile | Standard |
| Case Material | ABS / ABS + Aluminum |
| Knob | No |
| Connectivity | Bluetooth 5.1 / USB-C |
| Polling Rate | 1000 Hz (wired) |
| Hot-swap | Yes |
| Firmware | QMK / VIA |
| Firmware Source | [Link](https://github.com/Keychron/qmk_firmware/tree/bluetooth_playground/keyboards/keychron/k4_pro) |
...
- [Firmware Source (K4 Pro)](https://github.com/Keychron/qmk_firmware/tree/bluetooth_playground/keyboards/keychron/k4_pro)
