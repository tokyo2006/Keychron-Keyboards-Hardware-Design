# Keychron M3 — Hardware Design Files

> Lightweight wireless optical mouse with ergonomic shaping, tri-mode connectivity, and high-performance sensor options.
...
| File | Description |
|---|---|
| `M3-20230409.stp` | Complete 3D model containing shell, buttons, and all components |
