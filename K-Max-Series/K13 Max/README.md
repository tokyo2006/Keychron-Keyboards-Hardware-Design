# Keychron K13 Max — Hardware Design Files

> 80% low-profile 90-key ultra-slim wireless mechanical keyboard with tri-mode connectivity and 1000 Hz polling rate.

**Product page:** [Keychron K13 Max](https://www.keychron.com/products/keychron-k13-max-qmk-via-wireless-custom-mechanical-keyboard)

![K13 Max](https://cdn.shopify.com/s/files/1/0059/0630/1017/files/K13-Max-4.jpg?v=1707097937)

## Specifications

| Spec | Detail |
|---|---|
| Layout | 80% compact with numpad (90-key) |
...
- [Firmware Source (K13 Max)](https://github.com/Keychron/qmk_firmware/tree/wireless_playground/keyboards/keychron/k13_max)
