# Keychron V10 Max — Hardware Design Files

> 75% Alice layout, 82-key wireless gasket-mounted custom mechanical keyboard with rotary encoder knob. Tri-mode connectivity (Bluetooth 5.1 / 2.4 GHz / USB-C).

**Product page:** [Keychron V10 Max](https://www.keychron.com/products/keychron-v10-max-qmk-via-wireless-custom-mechanical-keyboard)

![V10 Max](https://www.keychron.com/cdn/shop/files/Keychron-V10-Max-wireless-mechanical-keyboard55_2048x.jpg?v=1708920832)

## Specifications

| Spec | Detail |
|---|---|
| Layout | 75% Alice (82-key) |
| Case Material | Plastic |
| Mount | Gasket |
| Knob | Yes (rotary encoder) |
...
- [Firmware Source (V10 Max)](https://github.com/Keychron/qmk_firmware/tree/wireless_playground/keyboards/keychron/v10_max)
