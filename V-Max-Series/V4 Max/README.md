# Keychron V4 Max — Hardware Design Files

> 60% layout, 61-key wireless gasket-mounted custom mechanical keyboard. Tri-mode connectivity (Bluetooth 5.1 / 2.4 GHz / USB-C).
...
| Hot-swap | Yes |
| Firmware | QMK / VIA |
| Firmware Source | [Link](https://github.com/Keychron/qmk_firmware/tree/wireless_playground/keyboards/keychron/v4_max) |
...
- [Firmware Source (V4 Max)](https://github.com/Keychron/qmk_firmware/tree/wireless_playground/keyboards/keychron/v4_max)
